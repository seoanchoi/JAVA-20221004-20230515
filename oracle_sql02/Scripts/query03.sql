/*
 * DML : 데이터 조작어
 *       테이블에 데이터를 추가(INSERT), 수정(UPDATE), 삭제(DELETE) 하기 위한 명령을 제공한다.
 * 
 * INSERT
 ...
 *     주의: 명시한 컬럼명과 VALUES 의 값이 순서대로 매치되어야 한다.
 * 
 * UPDATE
 *     UPDATE <테이블명> SET <컬럼명> = <값>;
 *     주의: 테이블의 모든 Record의 컬럼값이 수정된다.
 * 
 *     UPDATE <테이블명> SET <컬럼명> = <값> WHERE <컬럼명> = <값> <연산자> <값>;
 ...
 *     참고: WHERE 절을 사용하여데이터를 삭제할 Rcord 를 선택할 수 있다.
 */
