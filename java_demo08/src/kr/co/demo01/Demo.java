...
public class Demo {
	...
	public static void main(String[] args) {
		...
		str1 = new String("endsWith(), startWith() 메서드 예제");
		res1 = str1.endsWith("예제");
		res2 = str1.startsWith("end");
		System.out.println(res1 + "/" + res2);
		
		// equalsIgnoreCase() : 대소문자 구분을 무시하고 동일한 문자열인지에 대한 유무를
		//     반환하는 메서드
		...
		// split() : 문자열을 특정 문자를 기준으로 분리하여 문자열 배열 반환하는 메서드
		str1 = new String("11 버전에서\n새로 생긴\nlines()\n메서드");
